...
var accountBanks = new List<Stat>
{
...
var stats = banks.Select(l => accountBanks.Where(r => r.Bank == l).DefaultIfEmpty(new Stat{Bank = l, Quantity = 0}).ToList()).SelectMany(t =>t).ToList();
```
